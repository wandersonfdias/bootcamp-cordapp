...
// message from `CadastrarPessoaFlowInitiator.Initiator`.
@InitiatedBy(CadastrarPessoaFlowInitiator.class)
public class CadastrarPessoaFlowResponder extends FlowLogic<Void> {
    ...
    public CadastrarPessoaFlowResponder(FlowSession counterpartySession) {
